...
try {
    ...
    function uploadImage($file, $typeArticle) {
        $baseUploadDir = 'uploads/';
    
        // Choisir le dossier en fonction du type d'article
        if ($typeArticle === 'vetement') {
            $uploadDir = $baseUploadDir . 'vetements/';
        } elseif ($typeArticle === 'produit'){
            $uploadDir = $baseUploadDir . 'produits/';
        }
